        ...
        if topic_el:
            ...
            if matching_card:
                ...
                if wait_for_loading(driver):
                    ...
                    print("\n--- TESTING Q5 WITH LAYOUT SWITCHING ---")
                    ...
                    if visible_inputs:
                        ...
                        # Enter answer with variable and math template: a + \sqrt{34}
                        enter_math_answer(driver, "a+\\sqrt{34}")
                        time.sleep(2.0)
                        
                        # Save screenshot
                        os.makedirs("screenshots", exist_ok=True)
                        driver.save_screenshot("screenshots/test_keypad_switch_result.png")
                        print("Saved screenshots/test_keypad_switch_result.png")
                    else:
